...
public class MonitorUtils {
    ...
    public RuntimeDetail monitorRuntimeDetail() {
        ...
        try {
            HardwareAbstractionLayer hardware = info.getHardware();
            NetworkIF networkIntFace = Objects.requireNonNull(this.findNetworkInterface(hardware));
            CentralProcessor processor = hardware.getProcessor();
            double upload = networkIntFace.getBytesSent(), download = networkIntFace.getBytesRecv();
            ...
            networkIntFace = Objects.requireNonNull(this.findNetworkInterface(hardware));
            upload = (networkIntFace.getBytesSent() - upload) / statisticTime;
            download = (networkIntFace.getBytesRecv() - download) / statisticTime;
