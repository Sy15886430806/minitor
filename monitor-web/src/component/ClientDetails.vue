...
import {copyIp, cpuNameToImage, osNameToIcon, rename} from "@/tools/index.js";
      ...
      <div v-if="details.base.online">
        <div style="display: flex">
          ...
          <el-progress style="margin-left: 20px" type="dashboard" :width="100"
                       :percentage="60" status="success">
            <div style="font-size: 16px;font-weight: bold;color: initial">内存</div>
            <div style="font-size: 13px;color: grey;margin-top: 5px">10 GB</div>
          </el-progress>
